...
export default function MyPurchasesPage() {
  ...
  useEffect(() => {
    ...
    const connection = new HubConnectionBuilder()
      .withUrl("http://localhost:5062/purchaseHub", {
    ...
    connection.on("PurchaseStatusChanged", (purchaseId: number, newStatus: string, date: Date) => {
      console.log("Recebida atualização de status:", purchaseId, newStatus);
    ...
    return () => {
      connection.off("PurchaseStatusChanged");
    };
  }, []);
